...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("breedablefish:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("breedablefish:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("breedablefish:pinky", pinkyEventData);
	}
}
